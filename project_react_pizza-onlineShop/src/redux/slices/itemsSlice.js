...
export const itemsSlice = createSlice({
  ...
  extraReducers: {
    //обрабатываем все 3 варианта ассинхронного щапроса: pending идет загрузка ,
   // fulfilled данные загружены успешно
    //
...
export const selectItemsData = (state) => state.items;//export slica otdelno

export const { setItems, setItem, setActiveSize, setActiveType } =
  itemsSlice.actions;//export actions otdelno

export default itemsSlice.reducer;//export reducers otdelno
